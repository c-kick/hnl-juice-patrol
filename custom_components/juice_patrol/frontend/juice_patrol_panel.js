...
`;function dt(e,t,i){return getComputedStyle(e).getPropertyValue(t).trim()||i}function ht(e){const t=e._settingsValues?.low_threshold??20;return{icon:{title:"",type:"icon",moveable:!1,showNarrow:!0,template:e=>U`
  ...
  `}(t)}
    ...
    ${function(e,t){const i=e._detailEntity,a=null!=t.predictedEmpty,n=Ke(t.level,t.threshold),s=ot(t),r=a?function(e){const t=e.daysRemaining;return null==t?"—":t<=1?Math.round(24*t)+"h":(Math.round(10*t)/10).toString()}(t):Ze(t.level),o=a?"days remaining":"battery level",l=null!=t.level?Math.max(0,Math.min(100,Math.ceil(t.level))):0,c=Ze(t.level),d=n,h=e._chartData,p=h?.prediction||{},u=h?.charge_prediction,g={normal:"Normal",charging:"Charging",flat:"Flat",idle:"Idle",noisy:"Noisy",insufficient_data:"Insufficient data",single_level:"Single level",insufficient_range:"Insufficient range"},m="normal"===p.status&&null!=p.estimated_days_remaining&&p.estimated_days_remaining<=0,v=m?"Depleted":g[p.status]||p.status||"—",y=u?.estimated_full_timestamp?it(1e3*u.estimated_full_timestamp,!0):t.predictedEmpty?it(t.predictedEmpty,Qe(t)):m&&p.estimated_empty_timestamp?it(1e3*p.estimated_empty_timestamp,!0):"—",b=u?.estimated_full_timestamp?"Full by":m?"Reached empty":"Empty by",f=u?.confidence||p.confidence,_={high:"High",medium:"Medium",low:"Low",insufficient_data:"Insufficient","history-based":"History"},x=f?_[f]||f:"—";return U`
