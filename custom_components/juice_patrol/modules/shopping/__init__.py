...
class ShoppingModule(JuicePatrolModule):
    ...
    MODULE_ID = "shopping"
    DEPENDENCIES = ("battery_id", "monitoring")
    ...
    def ws_command_definitions(cls) -> list[WsCommandDefinition]:
        return [
            WsCommandDefinition(
                command_type="juice_patrol/get_shopping_list",
                schema={},
                handler_method="handle_ws_get_shopping_list",
            ),
        ]

    async def handle_ws_get_shopping_list(self, hass, connection, msg):
