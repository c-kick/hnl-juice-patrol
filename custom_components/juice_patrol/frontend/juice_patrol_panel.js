...
`;function Le(e,t,a){return getComputedStyle(e).getPropertyValue(t).trim()||a}function Ce(e){const t=e._settingsValues?.low_threshold??20;return{icon:{title:"",type:"icon",moveable:!1,showNarrow:!0,template:e=>U`
  ...
  `}(t)}
    ...
    ${function(e,t){const a=e._chartData,i=a?.prediction||{},s=a?.charge_prediction,n="history-based"===s?.status,r={normal:"Normal discharge",charging:"Currently charging",flat:"Flat — no significant discharge detected",idle:"Idle — not currently discharging",noisy:"Noisy — data too irregular for prediction",insufficient_data:"Not enough data for prediction",single_level:"Single level — all readings identical",insufficient_range:"Insufficient range — readings too close together"}[i.status]||i.status||"Unknown",l=me(t.level,t.threshold);return U`
    <div class="detail-meta">
      ...
      ${t.predictedEmpty||!i.status||"normal"===i.status||"charging"===i.status&&null!=a?.charge_prediction?.segment_start_timestamp&&!n?W:U`<div class="detail-reason">
