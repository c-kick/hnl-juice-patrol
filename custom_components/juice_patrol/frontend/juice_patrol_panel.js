...
`;function dt(e,t,i){return getComputedStyle(e).getPropertyValue(t).trim()||i}function ht(e){const t=e._settingsValues?.low_threshold??20;return{icon:{title:"",type:"icon",moveable:!1,showNarrow:!0,template:e=>U`
          ...
          <div class="replacement-table-row ${i.type}">
            ...
            <span>
              ${"confirmed"===i.type?U`
                ...
                Replaced
              `:U`
                <ha-icon icon="mdi:help-circle-outline" style="--mdc-icon-size:16px;color:${ze}"></ha-icon>
  ...
  `}const mt=[{key:"critical",min:0,max:10,label:"0–10%",color:xe},{key:"warning",min:11,max:50,label:"10–50%",color:_e},{key:"healthy",min:51,max:100,label:"50–100%",color:fe}];function vt(e){if(!e||e.length<2)return{count:e?.length??0,intervals:[],avgDays:null,accelerating:!1};const t=[...e].sort((e,t)=>e-t),i=[];for(let e=1;e<t.length;e++)i.push((t[e]-t[e-1])/86400);const a=Math.round(i.reduce((e,t)=>e+t,0)/i.length),n=i[i.length-1],s=i.length>1?i.slice(0,-1).reduce((e,t)=>e+t,0)/(i.length-1):a,r=i.length>=2&&n<.5*s;return{count:t.length,intervals:i,avgDays:a,accelerating:r}}function yt(e){const t=e._entities||[],i=function(e){const t={};for(const e of mt)t[e.key]=0;let i=0,a=0,n=0,s=0;for(const r of e){if(s++,null==r.level){n++;continue}if(r.isStale){a++;continue}if(r.isRechargeable){i++;continue}const e=Math.ceil(r.level);for(const i of mt)if(e>=i.min&&e<=i.max){t[i.key]++;break}}return{buckets:t,rechargeable:i,stale:a,unavailable:n,total:s}}(t);e._fleetData=i;const a=function(e){return e.filter(e=>null!=e.level&&!e.isRechargeable&&null!=e.daysRemaining).sort((e,t)=>e.daysRemaining-t.daysRemaining).slice(0,5)}(t),n=function(e,t){const i=t?.replacement_data||{},a=[];for(const t of e){if(null==t.level||t.isRechargeable)continue;let e=0;const n=i[t.sourceEntity],s=n?.replacement_history?.length??0;null!=t.dischargeRate&&Math.abs(t.dischargeRate)>5?e+=30:null!=t.dischargeRate&&Math.abs(t.dischargeRate)>1&&(e+=15),t.isLow?e+=25:t.level<40&&(e+=10),"cliff"===t.anomaly&&(e+=20),"rapid"===t.anomaly&&(e+=25),"erratic"===t.stability&&(e+=15),s>=3?e+=30:s>=2&&(e+=15),null!=t.daysRemaining&&t.daysRemaining<=7?e+=20:null!=t.daysRemaining&&t.daysRemaining<=30&&(e+=10),e>0&&a.push({entity:t,score:e,replCount:s,replData:n})}return a.sort((e,t)=>t.score-e.score),a.slice(0,3)}(t,e._dashboardData),s=function(e){const t={};for(const i of e){if(null==i.level)continue;let e;if(i.isRechargeable)e="Rechargeable";else{const t=i.batteryType?.match(/^(?:\d+\s*[×x]\s*)?(.+)$/i);e=t?t[1].trim():i.batteryType||"Unknown"}t[e]||(t[e]={type:e,devices:[],isRechargeable:"Rechargeable"===e}),t[e].devices.push(i)}const i=Object.values(t).sort((e,t)=>t.devices.length-e.devices.length);for(const e of i){e.buckets={};for(const t of mt)e.buckets[t.key]=0;for(const t of e.devices){const i=Math.ceil(t.level);for(const t of mt)if(i>=t.min&&i<=t.max){e.buckets[t.key]++;break}}}return i}(t);e._healthByTypeData=s;const r=function(e){let t=0,i=0,a=0,n=0;for(const s of e)null!=s.level&&(s.isRechargeable||(i++,a+=s.level,n++,s.isLow||t++));return{readiness:i>0?Math.round(t/i*100):100,aboveThreshold:t,totalDisposable:i,avgLevel:n>0?Math.round(a/n):0}}(t);return U`
    <div class="jp-dashboard">
      ${function(e,t){const i=t.readiness>=80?Me:t.readiness>=50?ze:He;return U`
    <ha-card>
      ...
      <div class="db-overview-stats">
        ...
        <div class="db-stat">
          <span class="db-stat-value" style="color:${t.avgLevel<=10?He:t.avgLevel<=50?ze:Me}">${t.avgLevel}%</span>
