...
`;function ht(e,t,i){return getComputedStyle(e).getPropertyValue(t).trim()||i}function pt(e){const t=e._settingsValues?.low_threshold??20;return{icon:{title:"",type:"icon",moveable:!1,showNarrow:!0,template:e=>U`
  ...
  `}(t)}
    ...
    ${function(e,t){const i=e._detailEntity,a=null!=t.predictedEmpty,n=Qe(t.level,t.threshold),s=lt(t),r=a?function(e){const t=e.daysRemaining;return null==t?"—":t<=1?Math.round(24*t)+"h":(Math.round(10*t)/10).toString()}(t):Ge(t.level),o=a?"days remaining":"battery level",l=null!=t.level?Math.max(0,Math.min(100,Math.ceil(t.level))):0,c=Ge(t.level),d=n,h=e._chartData,p=h?.prediction||{},u=h?.charge_prediction,m={normal:"Normal",charging:"Charging",flat:"Flat",idle:"Idle",noisy:"Noisy",insufficient_data:"Insufficient data",single_level:"Single level",insufficient_range:"Insufficient range"},g="normal"===p.status&&null!=p.estimated_days_remaining&&p.estimated_days_remaining<=0,v=g?"Depleted":m[p.status]||p.status||"—",y=u?.estimated_full_timestamp?at(1e3*u.estimated_full_timestamp,!0):t.predictedEmpty?at(t.predictedEmpty,Xe(t)):g&&p.estimated_empty_timestamp?at(1e3*p.estimated_empty_timestamp,!0):"—",b=u?.estimated_full_timestamp?"Full by":g?"Reached empty":"Empty by",f=u?.confidence||p.confidence,_={high:"High",medium:"Medium",low:"Low",insufficient_data:"Insufficient","history-based":"History"},x=f?_[f]||f:"—";return U`
