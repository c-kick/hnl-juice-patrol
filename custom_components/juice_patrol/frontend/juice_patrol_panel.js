...
`;function Fe(e){const t=e._settingsValues?.low_threshold??20;return{icon:{title:"",type:"icon",moveable:!1,showNarrow:!0,template:e=>O`
  ...
  `}(e))}</div>`:B}
        ...
        `}},level:{title:"Level",sortable:!0,type:"numeric",valueColumn:"_levelSort",minWidth:"70px",maxWidth:"90px",showNarrow:!0,template:e=>{const i=He(e.level,e.threshold,t);return O`<span style="color:${i};font-weight:500">${Re(e.level)}</span>`}},batteryType:{title:"Type",sortable:!0,minWidth:"60px",maxWidth:"90px",template:e=>O`<span
  ...
  `}(t)}
    ...
    ${function(e,t){const i=e._detailEntity,a=He(t.level,t.threshold),r=Pe(t),s=Re(t.level),n="battery level",o=null!=t.level?Math.max(0,Math.min(100,Math.ceil(t.level))):0,l=Re(t.level),c=a;return O`
    <ha-card style="container-type:inline-size;container-name:hero;margin-bottom:16px">
        ...
        <div class="hero-right">
          <div class="hero-name-row">
            ...
            <ha-icon-button
              ...
              style="--mdc-icon-button-size:32px;--mdc-icon-size:20px;color:${je}"
              title="More info"
      ...
      <div class="hero-stats">
        ...
        <div class="hero-stat">
          ...
          <div class="hero-stat-val">${t.isStale?"Stale":t.isLow?"Low":t.isRechargeable&&t.chargingState?"charging"===t.chargingState?"Charging":"discharging"===t.chargingState||"not_charging"===t.chargingState?"Discharging":"full"===t.chargingState?"Full":"OK":"OK"}</div>
        </div>
        <div class="hero-stat">
    ...
    <ha-card style="margin-bottom:16px">
      <ha-expansion-panel>
        <div slot="header" style="display:flex;align-items:center;gap:8px;width:100%">
          <ha-icon icon="mdi:history" style="--mdc-icon-size:20px;color:${je}"></ha-icon>
